...
2. **Verify Fix**
   - Run the project's type checker / compiler — zero errors
   - Run the project's build command — clean build
...
| **4. Implementation** | Fix root cause, verify builds clean | Bug resolved, no regressions |
