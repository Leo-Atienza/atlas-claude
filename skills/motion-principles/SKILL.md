...
metadata:
  author: LottieFiles
  version: "1.0.0"
  vendored_from: "github:lottiefiles/motion-design-skill@f9a8a04"
---

> **In the ATLAS web-dev system:** the *why & how-much* planning layer for motion — personality archetypes, duration/easing tables, emotion→motion mapping, choreography/stagger budgets. Decide the *feel* here FIRST, then implement the mechanics with the CSS keyframe catalog (SK-146 `css-keyframe-animations`), Motion (SK-047), or GSAP (SK-042/044 + SK-149 `gsap-plugins`). Vendored verbatim from LottieFiles, MIT — see NOTICE.md.
