...
Read `~/.claude/projects/<PROJECT_MEMORY_DIR>/memory/INDEX.md` and scan for tags matching: `#nextjs`, `#tailwind`, `#css`, `#framer-motion`, `#daisy-ui`, `#animation`, `#performance`, `#scroll`.
