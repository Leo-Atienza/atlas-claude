...
2. **Check session history** — Read `~/.claude/projects/<your-cwd-slug>/memory/sessions/sessions-index.md` and scan for sessions that used technologies matching archived skills.
