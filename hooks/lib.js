...
const ALL_HOOKS = ['context-guard', 'post-tool-monitor', 'tool-failure-handler', 'tsc-check', 'pre-commit-gate', 'session-start', 'session-stop', 'precompact-reflect', 'auto-formatter', 'statusline', 'cctools-bash', 'cctools-file-length', 'cctools-env-protection', 'claudio'];
const HOOK_PROFILES = {
