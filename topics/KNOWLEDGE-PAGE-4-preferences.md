# Knowledge Store — Page 4: Preferences (type: preference)

> User preferences that guide Claude's behavior. Each entry captures what the user wants and when to apply it.

---

## KNOWLEDGE-060: Flow for Multi-Phase
**Date**: 2026-02-25 | **Type**: preference | **Tags**: #workflow #flow
...
## KNOWLEDGE-061: Continuous Evolution
**Date**: 2026-02-27 | **Type**: preference | **Tags**: #learning #memory
...
## KNOWLEDGE-062: Community Best Practices
**Date**: 2026-02-27 | **Type**: preference | **Tags**: #setup #optimization
...
## KNOWLEDGE-067: Pending Web Libraries (npm)
**Date**: 2026-04-09 | **Type**: preference | **Tags**: #web #libraries #react #next.js
...
## KNOWLEDGE-063: Done Workflow Commit+Reflect
**Date**: 2026-03-08 | **Type**: preference | **Tags**: #workflow #git #reflection
...
## KNOWLEDGE-064: Bundle Related Commits
**Date**: 2026-03-08 | **Type**: preference | **Tags**: #git #commits
...
## KNOWLEDGE-065: Premium Non-Generic UI
**Date**: 2026-03-10 | **Type**: preference | **Tags**: #design #ui #magic-ui #animation
...
## KNOWLEDGE-066: Full Codebase Scan Before Implementation
**Date**: 2026-03-31 | **Type**: preference | **Tags**: #workflow #discovery
